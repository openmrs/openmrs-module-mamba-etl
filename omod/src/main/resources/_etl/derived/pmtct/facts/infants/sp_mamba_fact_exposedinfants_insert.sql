-- $BEGIN
INSERT INTO mamba_fact_pmtct_exposedinfants (encounter_id,
                                             infant_client_id,
                                             encounter_datetime,
                                             mother_client_id,
                                             visit_type,
...
WHERE (ip.client_id in (SELECT person_b
                        FROM mamba_dim_relationship a
    ...
    OR ip.client_id in (SELECT person_b
                        FROM mamba_dim_relationship a
